...
Staking to root is *essentially* the same as staking pre-dTao.  Select a validator present on the root subnet, and stake your tao on that validator.  You will begin to receive a proportion of the validator's earnings on each subnet where the validator is active.
...
(Note that *subnet launch* for existing subnets is the block where dtao launches)

![](https://files.readme.io/a1d8b7d200586cace4ec0bbfd7e27bfc973a6276fc331a4273df4a0f6cd59d9b-image.png)

<Image alt="Root/alpha emission for a Subnet starting with 9M tao in circulation at day 0. (This chart does account for the halvening at 10.5M blocks lowering tao and alpha emissions)" align="center" src="https://files.readme.io/824a92e85a4ce5dba612f58e3ea9ad05528ffb5b21beaa58320f122298c84096-Screenshot_2025-01-10_at_12.54.07.jpg">
...
from pallets/src/run\_coinbase.rs (line 27):
