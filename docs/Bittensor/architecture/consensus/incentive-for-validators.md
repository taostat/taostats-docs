...
[Child Hotkeys](doc:child-hotkeys) also can also play a role in emission for validators, but at the time of writing, no parent hotkey added to a child hotkey has added a take.
