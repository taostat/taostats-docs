---
title: Deploy a Rao Chain on a Mac
excerpt: ''
deprecated: false
hidden: false
metadata:
...
we need to update the `scripts/localnet.sh` on line 34.  In testing, raonet does not work with fastblocks. (this may change before launch).  We want to have the pow-faucet to distribute tao to our wallets.
