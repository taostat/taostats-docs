...
Inside the pool, the tao/alpha ratio is a constant.  Another way to think about this is that the product of the to values is a constant k:
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/1f998f12d0010bdc3c676a0b68da311153f8fa0bb345818a9e5c0669706bcf1c-image.png",
        null,
        ""
      ],
      "align": "center",
...
> 
> ![](https://files.readme.io/d0b38dd0a67438244876ee502dfd6c319f88921f19ce48151752dbd218e212b1-image.png)
> 
> k = 100\* 100 = 10,000
...
> 📘 If there is 100 tao_in, and 100 alpha_in, the α\_price will be 1 tao.
