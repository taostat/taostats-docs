...
The emitted tao is distributed to the subnet pools of each subnet.  The distribution is determined by the ratio of subnet price over the sum of all subnet prices:
