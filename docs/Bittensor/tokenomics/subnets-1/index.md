...
Step 2: [Alpha Emission](doc:alpha-emission): Up to 2 alpha is emitted per subnet per block.  This page describes the split between the Subnet Pool (alpha\_in) and subnet participants (alpha\_out).
