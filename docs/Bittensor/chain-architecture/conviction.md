...
title: Conviction
excerpt: >-
  Conviction is the process of locking alpha to a subnet to show conviction
  (reduces rugpulls) (May 2026)
deprecated: false
hidden: false
metadata:
  robots: index
...
<Callout icon="📘" theme="info">
  Conviction can be seen for each subnet on taostats:

  ![](https://files.readme.io/e14ee0fc987ed507d5aaa66ac37d7de449538f05845dfcc191ee75642ba524d4-image.png)

  We have built a listing of all convictions, as well as a tool to estimate conviction growth:

  https://s3.hippius.com/rufus/public/conviction-sim/index.html

   

  ![](https://files.readme.io/d3ecdb5d76bfad921ec5008a61d2ad51bd14cd0c022c2344937fa71ad810ac5d-image.png)
</Callout>
