...
next:
  description: ''
---
![](https://github.com/eclipsevortex/SubVortex/raw/main/subvortex.png)
...
# [HW Requirements](https://github.com/eclipsevortex/SubVortex/blob/main/min_compute.yml)