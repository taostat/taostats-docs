...
next:
  description: ''
---
![Subnet21](https://github.com/ifrit98/storage-subnet/raw/main/assets/Subnet21.png)
...
# [HW Requirements](https://github.com/ifrit98/storage-subnet/blob/main/min_compute.yml)