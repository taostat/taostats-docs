...
A list of the most commonly used extrinsics in Bittensor
...
See our page on [Multisig extrinsics](/docs/multisig-extrinsics)
...
## [batch](/docs/batch-extrinsics)

## [batch\_all](/docs/batch-extrinsics)

## [force\_batch](/docs/batch-extrinsics)
