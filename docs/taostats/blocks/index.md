...
![](https://files.readme.io/4b50636-image.png)

# Extrinsics:

Extrinsics are collections of events that are included in the block. In the table for each block, the Extrinsic Name, the Hotkey and the result (succeeded/failed) are displayed:

![](https://files.readme.io/5a85a2a-image.png)

# Events: A collection of Extrinsics make up an event.
