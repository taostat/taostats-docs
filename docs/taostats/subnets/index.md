...
<Image alt="Subnet listing as of 1/29/2024" align="center" src="https://files.readme.io/823b9da-image.png">
...
* Emissions: The % of [Subnet Emission](doc:subnets-emission) for the subnet.
...
![](https://files.readme.io/fbcf7d6-image.png)
...
![](https://files.readme.io/607b57f-image.png)

* [Metagraph](doc:metagraph): Details on each node in the subnet (miners and validators).
* [Hyperparameters](doc:subnet-parameters)
* [Registration](doc:registration): Information on registration and de-registration.
* [Distribution](doc:distribution): Display of emissions of the miners.
