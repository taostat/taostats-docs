...
For validators, this must be calculated _per subnet_ and then is added for a network-wide value.
...
- [Staking Calculator](https://taostats.io/staking)  This is the 30 day average. This _smooths out_ changes in the value that occur from changes in stake.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/3eb50ad88324a1b852029c3b6fcaa14be8c47326fea933e024b9b04630644933-image.png",
        null,
        ""
      ],
      "align": "center",
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/449da9091d3d09eb781efaa4bc7c1efde5648d12bc3073486befbd5ec2130a35-Screenshot_2024-10-04_at_10.20.25.jpg",
        null,
        ""
      ],
      "align": "center"
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/c647dd1fd28a5f15b5f51d065865a9d90ac26e41de03f2c88cb2628d5e516b09-Screenshot_2024-10-04_at_10.21.49.jpg",
        null,
        ""
      ],
      "align": "center"
...
- Emission for the registered hotkey.  
  ...
  - Calculate the % of stake held by the child hotkey \* the emission. (Note if there is no parent/child, the % of stake held is 100%)
    ...
    [block:image]{"images":[{"image":["https://files.readme.io/c6cc5b7405f4a25f65b23433c98ce412cdf5612502f9f46ed8a3db06d458b291-Screenshot_2024-10-04_at_10.23.00.jpg",null,""],"align":"center"}]}[/block]
...
- Child hotkey takes. If there is a child hotkey, they can extract a childkey take from parent hotkeys.  Find the emission of the parent hotkey, and multiply by the childkey take.  Sum for all parent hotkeys.
  ...
  [block:image]{"images":[{"image":["https://files.readme.io/f0fdd056330e6a62415dd7e418f135efd9955108e4c92782920179701c2757f9-Screenshot_2024-10-04_at_10.33.51.jpg",null,""],"align":"center"}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/8596497f169045e7dcd6086bd462091c47a11180b87a55e633f60d5980bebfd6-Screenshot_2024-10-04_at_10.34.37.jpg",
        null,
        ""
      ],
      "align": "center"
