...
next:
  description: ''
---
On the [taostats homepage](taostats.io), a huge amount of data on Bittensor and the TAO coin is presented.
...
![](https://files.readme.io/47dff6c-image.png)

When trading mode is turned on, many additional options appear for the chart:

![](https://files.readme.io/f2acf10-image.png)
