...
Validators that weight copy are not contributing to the Bittensor ecosystem.  Validation of the miners is an essential part of the checks and balances of the Bittensor ecosystem.  Weight copying does not give back into the ecosystem, and pushes the work onto a smaller group of validators.
