...
excerpt: Use taostats in your Vibe coding/ bot creation.
deprecated: false
hidden: false
metadata:
  robots: index
...
Large Language Models (LLMs) are trained on data.  But, it does not know everything - what if the pages are not indexed?  What if the data is provate?
